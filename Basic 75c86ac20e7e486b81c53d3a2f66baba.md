...
[Basic.zip](Basic%2075c86ac20e7e486b81c53d3a2f66baba/Basic.zip)

sqlSession, mybatis, lucy-filter, interceptors
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="dataSource"
		...
		<property name="username" value="k1111" />
	...
	<mvc:interceptors>
		<mvc:interceptor>
			...
			<bean id="authInterceptor"
				class="com.boardK.interceptor.AuthInterceptor">
			</bean>
		</mvc:interceptor>
	</mvc:interceptors>
	 -->
